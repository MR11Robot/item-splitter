...
## How to Use
1. Press **K** to open the config screen
2. Click **Set Key** and press any key
...
## Installation
1. Download the latest `.jar` from [Releases](https://github.com/MR11Robot/item-splitter/releases)
